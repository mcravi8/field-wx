function App() {
  ...
  else if (nav === "sites") screen = <ScreenSites sites={sites} activeId={activeSite.id} units={unitsSystem} accent={t.accent} theme={resolvedTheme} onSelect={selectSite} onAdd={addSite} onDelete={deleteSite} onReorder={reorderSites} />;
